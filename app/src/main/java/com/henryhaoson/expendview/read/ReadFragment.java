...
public class ReadFragment extends BaseFragment {
    ...
    public void initView() {
        ...
        textView.setText("KIEV — The European Union warned Ukraine on Thursday time was running out to" +
                ...
                "charge in October 2011.The EU says the Tymoshenko case and those of other prosecuted opposition politicians" +
                "are examples of selective justice and are a barrier to Ukraine's ambition of European" +
                "integration.Two other issues raised by the bloc are related to the electoral system, which came" +
